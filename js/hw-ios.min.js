...
window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var d=(new Date).getTime(),e=Math.max(0,16-(d-a)),f=window.setTimeout(function(){b(d+e)},e);return a=d+e,f}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)})}(),function(a){TEMPLATES={"comments-toggle":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<button class="comments-toggle">'),d.b(d.v(d.f("comments_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_reply",a,b,0))),d.b("</button>"),
...
c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")}),a.pop()),d.s(d.f("has_comments",a,b,1),a,b,1,0,0,"")||d.b('<p class="no-comments">No comments.</p>')),d.b("</section>"),d.fl()},partials:{"<comments_list0":{name:"comments_list",partials:{},subs:{}}},subs:{}}),post:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<li id="story-'),d.b(d.v(d.f("id",a,b,0))),d.b('" data-index="'),d.b(d.v(d.f("i",a,b,0))),d.b('" class="post-'),d.b(d.v(d.f("type",a,b,0))),d.b('"><a href="/x/p/makefulltextfeed.php?&max=5&links=preserve&exc=&submit=Create+Feed&url='),
d.b(d.v(d.f("url",a,b,0))),d.b('" class="'),d.s(d.f("detail_disclosure",a,b,1),a,b,0,186,203,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("detail-disclosure")}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,240,250,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,279,287,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),
d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,377,661,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,410,449,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<div class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</div>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,587,629,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></div>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<div class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,712,757,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></div>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,861,935,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b('<a href="#/item/'),c.b(c.v(c.f("id",a,b,0))),c.b('" class="detail-disclosure-button"><span></span></a>')}),a.pop()),d.b("</li>"),d.fl()},partials:{},subs:{}}),"stories-load":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("loading",a,b,1),a,b,0,12,82,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,109,161,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load stories.</div>');
}),a.pop()),d.fl()},partials:{},subs:{}})}}(Hogan.Template),function(a){var b=a.document,c=a.$=function(a){return b.getElementById(a)},d={},e=function(a){var b={};for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b},f={pub:function(a,b){var c=d[a];if(c)for(var e=0,f=c.length;e<f;e++)c[e].call(this,b)},sub:function(a,b){d[a]||(d[a]=[]),d[a].push(b)},currentView:null,hideAllViews:function(){for(var a=b.querySelectorAll(".view"),c=0,d=a.length;c<d;c++)a[c].classList.add("hidden")},tmpl:function(a,b){
var c=TEMPLATES[a];if(c)return b?c.render(b):c},setTitle:function(a){var b="HackerWeb";a&&(a=a.replace(/^\s+|\s+$/g,""),a.toLowerCase()!=b.toLowerCase()&&(b=a+" – "+b)),document.title=b}};"undefined"!=typeof ga&&f.sub("logAPIError",function(a){ga("send","event","Errors","API",a)});var g=f.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);var h=b.createElement("a"),i={},j=function(a){var b=i[a];if(b)return b;h.href=a;
var c=h.hostname.replace(/^www\./,""),d=h.pathname.replace(/^\//,"").split("/")[0],e=d.length,f=c.length<=25&&e>3&&e<=15&&/^[^0-9][^.]+$/.test(d)?"/"+d:"";return b=c+f,i[a]=b,b},k=b.querySelector("#view-home .scroll"),l=k.querySelector("section"),m=!1;f.news={options:{disclosure:!0},markupStory:function(a){return/^item/i.test(a.url)?a.url="#/item/"+a.id:(a.external=!0,a.domain=j(a.url)),f.news.options.disclosure?("link"==a.type&&(a.detail_disclosure=!0),/^#\//.test(a.url)&&(a.detail_disclosure=!1,
a.disclosure=!0,a.domain=null)):a.id&&(a.url="#/item/"+a.id),a.i_point=1==a.points?"point":"points",a.i_comment=1==a.comments_count?"comment":"comments",g("post",a)},markupStories:function(a,b){var c="";b||(b=1);var d=f.news.markupStory;return a.forEach(function(a){a.i=b++,c+=d(a)}),c},updateStory:function(a){if(a&&a.id){var b,d=a.id,e=a.data,g="hacker-news",h=amplify.store(g);if(h)for(var i=0,j=h.length;i<j;i++){var k=h[i];if(d==k.id){b=k;break}}if(!b&&(g="hacker-news2",h=amplify.store(g)))for(var i=0,j=h.length;i<j;i++){
var k=h[i];if(d==k.id){b=k;break}}if(b){var l=!1;if(["title","url","time_ago","comments_count","points"].forEach(function(a){var c=e[a];b[a]!=c&&(b[a]=c,l=!0)}),l){amplify.store(g,h);var m=c("story-"+d);m&&(b.selected=!!m.querySelector("a[href].selected"),b.i=m.dataset?m.dataset.index:m.getAttribute("data-index"),m.insertAdjacentHTML("afterend",f.news.markupStory(b)),m.parentNode.removeChild(m))}}}},render:function(a){if(!m){a||(a={});var b=amplify.store("hacker-news-cached"),d=g("stories-load"),e=function(a){
var b=a.slice(),c='<ul class="tableview tableview-links" id="hwlist">'+f.news.markupStories(b)+(amplify.store("hacker-news2")?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";l.innerHTML=c,f.pub("onRenderNews")};if(b){var h=amplify.store("hacker-news"),i=a.delay;i?(m=!0,l.innerHTML=d.render({loading:!0}),setTimeout(function(){m=!1,e(h)},i)):e(h)}else{m=!0,l.innerHTML=d.render({loading:!0});var j=function(){l.innerHTML=d.render({load_error:!0
}),f.pub("logAPIError","news")};hnapi.news(function(a){return m=!1,!a||a.error?void j():(amplify.store("hacker-news",a),amplify.store("hacker-news-cached",!0,{expires:6e5}),amplify.store("hacker-news2",null),e(a),void hnapi.news2(function(a){a&&!a.error&&(amplify.store("hacker-news2",a),c("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip;<span class="loader"></span></a></li>'))}))},function(a){m=!1,j()})}}},reload:function(){f.news.render({delay:300})},more:function(a){
if(!a.classList.contains("loading")){a.classList.add("loading");var b=amplify.store("hacker-news2");setTimeout(function(){a.classList.remove("loading");var d=a.parentNode;if(d&&(d.parentNode&&d.parentNode.removeChild(d),b)){var e=b.slice(),g=f.news.markupStories(e,31);c("hwlist").insertAdjacentHTML("beforeend",g)}},400)}}};var n=c("view-comments"),o=n.querySelector("h1"),p=n.querySelector("section");f.comments={currentID:null,render:function(a){if(a){var c=amplify.store.sessionStorage("hacker-item-"+a);
if(f.comments.currentID!=a||!c){f.comments.currentID=a;var d=function(a,c){var d=e(a),h=g("post-comments");if(d.has_post=!!d.title,!d.has_post)return f.setTitle(),o.innerHTML="",p.innerHTML=h.render(d),f.pub("adjustCommentsSection"),void f.pub("onRenderComments");var i=g("comments");if(/^item/i.test(d.url)?d.url="//news.ycombinator.com/"+d.url:d.domain=j(d.url),d.has_comments=d.comments&&!!d.comments.length,d.i_point=1==d.points?"point":"points",d.i_comment=1==d.comments_count?"comment":"comments",
d.has_content=!!d.content,d.poll){var k=0,l=0;d.poll.forEach(function(a){var b=a.points;b>l&&(l=b),k+=b,a.i_point=1==b?"point":"points"}),d.poll.forEach(function(a){var b=a.points;a.percentage=(b/k*100).toFixed(1),a.width=(b/l*100).toFixed(1)+"%"}),d.has_poll=d.has_content=!0}d.short_hn_url="news.ycombinator.com/item?id="+c,d.hn_url="//"+d.short_hn_url,f.setTitle(d.title),o.innerHTML=d.title;var m=h.render(d,{comments_list:i}),n=b.createElement("div");n.innerHTML=m;for(var q=n.querySelectorAll("a"),r=0,s=q.length;r<s;r++){
var t=q[r];t.target="_blank"}var u=d.user;if(u)for(var v=n.querySelectorAll(".user"),r=0,s=v.length;r<s;r++){var w=v[r];w.textContent.trim()==u&&(w.classList.add("op"),w.title="Original Poster")}if(m.length>2e4)for(var x=n.querySelectorAll(".comments>ul>li>ul"),y=g("comments-toggle"),z=0,s=x.length;z<s;z++){var A=x[z],B=A.querySelectorAll(".metadata").length;A.style.display="none",B&&A.insertAdjacentHTML("beforebegin",y.render({comments_count:B,i_reply:1==B?"reply":"replies"}))}for(;p.hasChildNodes();)p.removeChild(p.childNodes[0]);
for(;n.hasChildNodes();)p.appendChild(n.childNodes[0]);delete n,f.pub("onRenderComments")};if(c)p.scrollTop=0,d(c,a);else{var h=amplify.store("hacker-news");if(h)for(var i=0,k=h.length;i<k;i++){var l=h[i];if(a==l.id){c=l;break}}if(!c){var h=amplify.store("hacker-news2");if(h)for(var i=0,k=h.length;i<k;i++){var l=h[i];if(a==l.id){c=l;break}}}c?(c.loading=!0,d(c,a)):d({loading:!0},a);var m=function(){c?(delete c.loading,c.load_error=!0,d(c,a)):d({load_error:!0},a),f.pub("logAPIError","comments")};hnapi.item(a,function(b){
if(f.comments.currentID==a){if(!b||b.error&&"comments"==f.currentView)return void m();amplify.store.sessionStorage("hacker-item-"+a,b,{expires:3e5}),f.news.updateStory({id:a,data:b}),d(b,a)}},function(b){f.comments.currentID==a&&m()})}}}},toggle:function(a){var b=a.nextElementSibling;if(b){var c=b.style,d=p.scrollTop;c.display="none"==c.display?"":"none",p.scrollTop=d}},reload:function(){f.comments.currentID=null,ruto.reload()}},f.init=function(){f.news.render(),ruto.init()},a.hw=f,ruto.config({before:function(a,b){
f.hideAllViews();var d=c("view-"+b);d.classList.remove("hidden"),f.currentView=b,f.setTitle(d.querySelector("h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(a,b){f.comments.render(b)})}(window),function(a){var b=a.document,c=b.body,d={clockwise:["flip-out-to-left","flip-in-from-left"],anticlockwise:["flip-out-to-right","flip-in-from-right"]},e=function(a){var b=a.in,e=a.out,f=b.classList,g=e.classList,h=a.direction,i=a.fn,j=d[h],k=function(){
b.removeEventListener("webkitAnimationEnd",k,!1),c.classList.remove("viewport-flip"),g.add("hidden"),f.remove("flip"),g.remove("flip"),g.remove(j[0]),f.remove(j[1]),i&&i.apply()};c.classList.add("viewport-flip"),f.remove("hidden"),g.add("flip"),f.add("flip"),b.addEventListener("webkitAnimationEnd",k,!1),g.add(j[0]),f.add(j[1])},f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},g=function(a){var b=a.in,c=a.out,d=b.classList,e=c.classList,g=b.getElementsByTagName("header")[0],h=c.getElementsByTagName("header")[0],i=g.classList,j=h.classList,k=a.direction,l=a.fn,m=f[k],n=function(){
e.add("hidden"),b.removeEventListener("webkitAnimationEnd",n,!1),e.remove("sliding"),d.remove("sliding"),e.remove(m[0]),d.remove(m[1]),i.remove("transparent"),j.remove("transparent"),l&&l.apply()};d.remove("hidden"),e.add("sliding"),d.add("sliding"),b.addEventListener("webkitAnimationEnd",n,!1),i.add("transparent"),j.add("transparent"),e.add(m[0]),d.add(m[1])},h=function(){return a.innerWidth>=640?"wide":"narrow"},i=b.querySelector("meta[name=viewport]");i||(i=b.createElement("meta"),i.name="viewport",
b.head.appendChild(i)),i.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";var j=navigator.userAgent,k=j&&/iPhone|iPod/.test(j),l=parseInt((j.match(/ OS (\d+)_/i)||[,0])[1],10)<6;k&&l&&c.classList.add("ios5");var m="wide"==h();a.addEventListener("resize",function(){var a="wide"==h();a!=m&&(m=a,location.reload())}),c.insertAdjacentHTML("beforeend",m?'<div id="overlay" class="hide"></div>':'<header class="fake"></header>'),ruto.config({before:function(a,b,c){
var d=hw.currentView,f=hw.hideAllViews,h=$("view-"+b);switch(hw.setTitle(h.querySelector("header h1").textContent),b){case"home":if(m){f(),$("overlay").classList.add("hide"),h.classList.remove("hidden");var i=$("view-comments");i.classList.remove("hidden"),i.querySelector("section").innerHTML='<div class="view-blank-state"><div class="view-blank-state-text">No Story Selected.</div></div>',i.querySelector("header h1").innerHTML="",i.querySelector("header a.header-back-button").style.display="none",
hw.comments.currentID=null,hw.pub("selectCurrentStory")}else d?"about"==d?e({in:h,out:$("view-"+d),direction:"anticlockwise"}):"home"!=d&&g({in:h,out:$("view-"+d),direction:"ltr"}):(f(),h.classList.remove("hidden"));hw.currentView="home";break;case"about":m?(h.classList.remove("hidden"),$("view-home").classList.remove("hidden"),$("view-comments").classList.remove("hidden"),setTimeout(function(){$("overlay").classList.remove("hide")},1)):d?"about"!=d&&e({in:h,out:$("view-home"),direction:"clockwise"
...
}}}),a.addEventListener("pagehide",function(){for(var a=b.querySelectorAll(".view"),c={},d=0,e=a.length;d<e;d++){var f=a[d];c[f.id]=f.querySelector(".scroll section").scrollTop||0}amplify.store("hacker-scrolltops",c)},!1);var n=function(){var a=amplify.store("hacker-scrolltops");setTimeout(function(){for(var b in a)$(b).querySelector(".scroll section").scrollTop=a[b]},1)};if(a.addEventListener("pageshow",n,!1),n(),k){var o=b.querySelectorAll(".view>.scroll"),p=null;Array.prototype.forEach.call(o,function(d){
d.addEventListener("touchstart",function(){if(a.innerHeight!=p){if(a.scrollTo(0,0),l){var d=b.createElement("div");d.style.height="600px",c.appendChild(d),setTimeout(function(){c.removeChild(d)},100)}p=a.innerHeight}},!1)})}tappable(".view>header a.header-button[href]",{noScroll:!0,onTap:function(a,b){var c=b.hash;m&&/about/i.test(ruto.current)&&"#/"==c?ruto.back("/"):location.hash=c}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var q=!1;tappable(".view>header h1",{onTap:function(a,b){
var d=b.parentNode.nextElementSibling.firstElementChild;if(0==d.scrollTop||q){if(k){var e=c.style.height;c.style.height="100%",setTimeout(function(){c.style.height=e},100)}}else{if(q)return;q=!0;var f=d.style.overflow;d.style.overflow="hidden",setTimeout(function(){d.style.overflow=f;var a,b=new TWEEN.Tween({scrollTop:d.scrollTop}).to({scrollTop:0},300).easing(TWEEN.Easing.Cubic.InOut).onUpdate(function(){d.scrollTop=this.scrollTop}).onComplete(function(){cancelAnimationFrame(a),b.stop(),q=!1,delete b;
}).start(),c=function(){TWEEN.update(),requestAnimationFrame(c)};a=requestAnimationFrame(c)},200)}}});var r;tappable("#view-home .tableview-links li>a:first-child",{allowClick:!m,activeClassDelay:100,inactiveClassDelay:m?100:1e3,onStart:function(a,b){if(m){var c=b.parentNode;c&&(c=c.parentNode,r=setTimeout(function(){c&&c.classList.add("list-tapped")},100))}},onMove:function(){m&&clearTimeout(r)},onEnd:function(a,b){if(m){clearTimeout(r);var c=b.parentNode.parentNode;setTimeout(function(){c&&c.classList.remove("list-tapped");
},100)}},onTap:function(b,c){c.classList.contains("more-link")?hw.news.more(c):/^#\//.test(c.getAttribute("href"))?location.hash=c.hash:c.href&&m&&a.open(c.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("#view-home .tableview-links li>a.detail-disclosure-button",{noScroll:!0,noScrollDelay:100,onTap:function(a,b){location.hash=b.hash}}),tappable("button.comments-toggle",function(a,b){hw.comments.toggle(b);
}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(a){if(m){a||(a=(location.hash.match(/item\/(\d+)/)||[,""])[1]);for(var b=$("view-home"),c=b.querySelectorAll("a[href].selected"),d=0,e=c.length;d<e;d++)c[d].classList.remove("selected");if(a){var f=b.querySelector('a[href*="item/'+a+'"]');f&&(f.classList.add("selected"),setTimeout(function(){f.scrollIntoViewIfNeeded?f.scrollIntoViewIfNeeded():f.scrollIntoView()},1))}}}),hw.sub("onRenderNews",function(){
hw.pub("selectCurrentStory")}),a.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1);var s=function(){var a=b.querySelector("#view-comments section");if(a){var c=a.querySelector(".post-content"),d=a.querySelector(".comments");if(d){var e=a.offsetHeight-c.offsetHeight+1,f=$("comment-section-style");f||(f=b.createElement("style"),f.id="comment-section-style",b.head.appendChild(f)),f.textContent=".view section.comments{min-height: "+e+"px;}";
...
a&&(a.classList.add("hide"),a.addEventListener("webkitTransitionEnd",function(){a.parentNode.removeChild(a)},!1))},200);hw.news.options.disclosure=!m,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",a.type="text/javascript",a.async="true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);
}();
